...
\begin{lstlisting}[frame=single,basicstyle=\tiny,caption=Counter example,label=counter-sts]
VAR
clk: BV(1);
rst: BV(1);
...
\begin{lstlisting}[frame=single,basicstyle=\tiny,caption=Counter example (hierarchical),label=counterh-sts]
VAR
  clk: BV(1);
  rst: BV(1);
