...
3) ``python3 cosa.py -i examples/mul_2_pe/system_1.json --equivalence examples/mul_2_pe/system_1.json -k 2`` (performs equivalenche check between system_1 and system2)
